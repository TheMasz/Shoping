...
export const SignIn = () => {
  ...
  const submitHandler = (e) => {
    e.preventDefault();
    dispatch(signin(emailOrUsername, password));
  };
  ...
  return (
    <section className="relative  min-h-screen flex  items-center ">
      <div className="container mx-auto flex w-full z-40">
        <div className="hidden md:block">
          <img className="w-full h-full " src="/ecom-1.png" alt="ecom-img" />
        </div>
        <div className="flex-1 flex flex-center">
          <div className="p-12 shadow-lg rounded-xl max-w-96 w-full content-bg">
            ...
            <Link to="/signup" className=" text-small">
